...
.dd-back-bar {
  position: sticky;
  top: calc(var(--hh) + env(safe-area-inset-top));
  z-index: 150;
  background: var(--bg);
  border-bottom: 1px solid var(--border);
  padding: 8px 16px;
...
const DAYS = [
  ...
  { key:"d_09_09", date:"09.09", dow:"יום ד׳", city:"tokyo1", title:"אסאקוסה, Oshiage ואקיהברה", emoji:"⛩️",
    hotel:"karaksa hotel colors Tokyo Yaesu",
    ...
    schedule:[
      ...
      {time:"09:00",emoji:"🛍️",title:"Nakamise Market",desc:"רחוב הקניות של אסאקוסה, חטיפים ומזכרות"},
      {time:"09:45",emoji:"🚃",title:"נסיעה ל-Oshiage",desc:"קו Tobu Skytree Line מ-Asakusa, תחנה אחת, ~5–10 דק׳"},
      {time:"10:15",emoji:"🦦",title:"✅ CAPPINESS Oshiage – בית קפה קאפיבארה",desc:"200 מ׳ מתחנת Tokyo Sky Tree. ¥4,000 לאדם, 40 דקות. נרכש!"},
      {time:"11:00",emoji:"🚃",title:"נסיעה לאוּאֶנו",desc:"חזרה לאסאקוסה → קו Ginza לאוּאֶנו, ~10 דק׳"},
      {time:"11:15",emoji:"🌳",title:"Ueno Park",desc:"גן אוּאֶנו — מוזיאונים, אגם, שלווה"},
      {time:"13:00",emoji:"🥩",title:"ארוחת צהריים בשוק אמייוקו",desc:"שוק Ameyoko הססגוני ליד אוּאֶנו — סושי, בשרים, חטיפים"},
      {time:"14:00",emoji:"🚃",title:"נסיעה לאקיהברה",desc:"JR Yamanote/Keihin-Tohoku, תחנה אחת, ~3–4 דק׳"},
